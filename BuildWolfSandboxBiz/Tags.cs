...
namespace BuildWolfSandboxBiz
{
	...
	/// </summary>
	/// <remarks>
	/// This class should not be instantiated directly. See <see cref="DataManager.GetTags"/>.
	/// This class should be customized.
	/// </remarks>
	public class Tags : TagsOrmTemplate
	{
		/// <summary>
		/// Constructor must have a row and data context.
		/// </summary>
		internal Tags( DataManager dataContext, DataRow ROW) : base( dataContext, ROW)
		{
			row = ROW;
		}
	}
	/// <summary>
	///	Holds a colection of Tagss that can be searched and enemerated.
	/// </summary>
	/// <remarks>
	/// This class should not be instantiated directly. See <see cref="DataManager.GetTagsCollection"/>.
	/// This class can be customized for more specific filters and finds
	/// </remarks>
	public class TagsCollection : TagsCollectionOrmTemplate
	{
